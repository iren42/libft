...
#    Updated: 2020/09/01 16:50:29 by iren             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS = ft_lstnew.c      ft_strlcat.c \
	ft_atoi.c          ft_strlcpy.c \
	ft_bzero.c         ft_strlen.c \
	ft_calloc.c        ft_strmapi.c \
	ft_isalnum.c       ft_memccpy.c     ft_strncmp.c \
	ft_isalpha.c       ft_memchr.c      ft_strnstr.c \
	ft_isascii.c       ft_memcmp.c      ft_strrchr.c \
	ft_isdigit.c       ft_memcpy.c      ft_strtrim.c \
	ft_isprint.c       ft_memmove.c     ft_substr.c \
	ft_itoa.c          ft_memset.c      ft_tolower.c \
	ft_putchar_fd.c  ft_toupper.c \
